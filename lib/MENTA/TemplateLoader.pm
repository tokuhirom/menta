...

{
    package MENTA::TemplateLoader::Instance;
    no strict 'refs';
    for my $meth (qw/escape_html unescape_html raw_string config render param env mobile_agent uri_for static_file_path docroot AUTOLOAD redirect current_url/) {
